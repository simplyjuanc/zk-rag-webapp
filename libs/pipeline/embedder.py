...
class DocumentEmbedder:
    ...
    async def embed_document_chunks(self, chunks: List[DocumentChunk]) -> List[EmbeddedChunk]:
...
class SimilarityCalculator:
    ...
    async def calculate_similarity(self, embedding1: EmbeddingResult, embedding2: EmbeddingResult) -> float:
    ...
    async def calculate_similarities(self, query_embedding: EmbeddingResult, embeddings: List[EmbeddingResult]) -> List[float]:
